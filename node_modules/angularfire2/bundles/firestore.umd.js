(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('angularfire2'), require('firebase/firestore')) :
    typeof define === 'function' && define.amd ? define(['exports', 'rxjs', 'rxjs/operators', '@angular/core', 'angularfire2', 'firebase/firestore'], factory) :
    (factory((global.angularfire2 = global.angularfire2 || {}, global.angularfire2.firestore = {}),global.rxjs,global.rxjs.operators,global.ng.core,global.angularfire2));
}(this, (function (exports,rxjs,operators,core,angularfire2) { 'use strict';
    ...
    var AngularFirestoreCollection = (function () {
        ...
        AngularFirestoreCollection.prototype.get = function (options) {
            return rxjs.from(this.query.get(options));
        };
    ...
    var AngularFirestore = (function () {
        function AngularFirestore(options, nameOrConfig, shouldEnablePersistence, settings, platformId, zone) {
            ...
            this.persistenceEnabled$ = zone.runOutsideAngular(function () {
                ...
                .pipe(operators.catchError(function () { return rxjs.of(false); }));
        }
        ...
        AngularFirestore.ctorParameters = function () { return [
            ...
            { type: Boolean, decorators: [{ type: core.Optional }, { type: core.Inject, args: [EnablePersistenceToken,] }] },
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [FirestoreSettingsToken,] }] },
