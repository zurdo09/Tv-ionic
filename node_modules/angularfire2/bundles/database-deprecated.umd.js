(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('angularfire2'), require('firebase/database')) :
    typeof define === 'function' && define.amd ? define(['exports', 'rxjs', 'rxjs/operators', '@angular/core', 'angularfire2', 'firebase/database'], factory) :
    ...
    function firebaseListObservable(ref, _a) {
        ...
        return operators.observeOn.call(listObs, new angularfire2.FirebaseZoneScheduler(new core.NgZone({}), {}));
    }
    ...
    function FirebaseObjectFactory(ref, _a) {
        ...
        return operators.observeOn.call(objectObservable, new angularfire2.FirebaseZoneScheduler(new core.NgZone({}), {}));
    }
    ...
    var AngularFireDatabase = (function () {
        ...
        AngularFireDatabase.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [angularfire2.FirebaseNameOrConfigToken,] }] },
            { type: String, decorators: [{ type: core.Optional }, { type: core.Inject, args: [angularfire2.RealtimeDatabaseURL,] }] },
            { type: core.NgZone }
        ]; };
